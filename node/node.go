...
import (
	...
	"github.com/Bruce960205/b7s/node/internal/waitmap"
...
func New(log zerolog.Logger, ctx context.Context, host *host.Host, peerStore PeerStore, fstore FStore, options ...Option) (*Node, error) {
